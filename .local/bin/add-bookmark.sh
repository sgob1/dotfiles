...
if [ "$bookmark" = "" ]; then
    ...
    tags=$(bemenu -i -l 10 --nb "#282828ff" --nf "#ebdbb2ff" --hb "#a9b665ff" --hf "#282828ff" --fb "#282828ff" --ff "#ebdbb2ff" --tb "#a9b665ff" --tf "#282828ff" --fn 'Iosevka SS16 Medium 11' --line-height 26 -p "Tags: #" --bottom < /dev/null)
